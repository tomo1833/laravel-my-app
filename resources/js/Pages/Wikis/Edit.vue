            ...
            <form @submit.prevent="updateWiki">
                <div class="container px-5 py-8 mx-auto bg-white">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" v-model="form.title" class="p-2 border rounded w-full" />
                    ...
                    <div class="mb-4">
                        <label class="block mb-2"></label>
                        <input type="text" name="body" v-model="form.body" class="p-2 border rounded w-full" />
                    ...
                    <div class="flex flex-row">
                        ...
                        <button type="button" @click="deleteWiki(form.id)"
