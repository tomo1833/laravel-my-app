...
const form = useForm("put", "/animeGenres/" + props.animeGenres.id, {
    id: props.animeGenres.id,
    name: props.animeGenres.name,
    order: props.animeGenres.order,
});

const updateAnimegenres = () => {
    form.submit({
        preserveScroll: true,
...
const deleteAnimegenres = (id) => {
    Inertia.delete(route("animeGenres.destroy", { animeGenres: id }), {
...
<template>
    ...
    <AuthenticatedLayout>
        <section class="text-gray-600 body-font py-24 relative">
            <form @submit.prevent="updateAnimegenres">
                <div class="container px-5 py-8 mx-auto bg-white">
                    ...
                    <div class="flex flex-row">
                        ...
                        <button
                            type="button"
                            @click="deleteAnimegenres(form.id)"
