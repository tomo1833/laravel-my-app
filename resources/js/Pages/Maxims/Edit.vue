...
const form = useForm("put", "/maxim/" + props.maxim.id, {
    id: props.maxim.id,
    title: props.maxim.title,
    body: props.maxim.body,
});
...
const deleteMaxim = (id) => {
    Inertia.delete(route("maxim.destroy", { maxim: id }), {
...
<template>
    ...
    <AuthenticatedLayout>
        <section class="text-gray-600 body-font py-24 relative">
            <form @submit.prevent="updateMaxim">
